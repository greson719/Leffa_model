...
class LeffaPredictor(object):
    ...
    def leffa_predict(self, src_image_path, ref_image_path, control_type, step=50, scale=2.5, seed=42, garment_type="upper_body"):
        """
          - control_type: one of ["virtual_tryon", "pose_transfer"].
          - garment_type: one of ["upper_body", "lower_body", "dresses"].
        """
        ...
        if control_type == "virtual_tryon":
            ...
            if self.vt_model_type == "viton_hd":
                ...
                # For dress_code, we compute an agnostic mask via openpose + parsing
